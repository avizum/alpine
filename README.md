...
### Bot Invite
Invite Ignition [here](https://discord.com/oauth2/authorize?client_id=756257170521063444&scope=bot&permissions=2147483647)
...
If you don't care, Here are instructions on how to run your own version of Ignition.
...
In `core/ignition.py`, change `OWNER_IDS` to your Discord IDs and change `PUBLIC_BOT_ID` to your bot's ID.
